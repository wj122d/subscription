...
try:
    ...
    print("错误：无法导入订阅转换器模块。请确保您在项目根目录运行此脚本。")
    sys.exit(1)
...
def run_server(port=8000, directory='web-ui/public'):
    """运行Web服务器"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Subscription Converter Web UI')
